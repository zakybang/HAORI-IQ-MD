...
exports.smsg = (conn, m, hasParent) => {
     ...
     */
     m.reply = async (text, chatId, options) => {
        conn.reply(chatId ? chatId : m.chat, text, m, { contextInfo: { mentionedJid: conn.parseMention(text), externalAdReply: { title: 'HΛӨЯIBӨƬZ 「 MD 」☇', body: `❏ ${date}\n`, sourceUrl: 'https://cutt.ly/vKIG2US', thumbnail: fs.readFileSync('./thumbnail.jpg')}}, options })
    }
